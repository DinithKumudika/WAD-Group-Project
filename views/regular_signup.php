...
<body>
  <div class="signup-opt">
    <a href="regular_signup.php"><button class="signup-opt-btn active">For Applicants</button></a> 
    <a href="emp_signup.php"><button class="signup-opt-btn">For Employers</button></a> 
  </div>
